...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<Page<PostSearchResponse>>> myPosting(Principal principal,
        @PageableDefault Pageable pageable) {
        Page<PostSearchResponse> response = postService.findMyPosting(
            Long.parseLong(principal.getName()), pageable);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<Page<PostSearchResponse>>> myVoteHistory(Principal principal,
        @PageableDefault Pageable pageable) {
        Page<PostSearchResponse> response = postService.findMyVoteHistory(
    ...
    public ResponseEntity<ApiResponse<Page<PostSearchResponse>>> myComment(Principal principal,
        @PageableDefault Pageable pageable) {
        Page<PostSearchResponse> response = postService.findMyComment(
            Long.parseLong(principal.getName()),
            pageable);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<Page<PostSearchResponse>>> myLike(Principal principal,
        @PageableDefault Pageable pageable) {
        Page<PostSearchResponse> response = postService.findMyLike(
            Long.parseLong(principal.getName()),
            pageable);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    @AuthorizationRequired(UserRole.GENERAL)
    public ResponseEntity<ApiResponse<Void>> registerLike(@PathVariable Long postId,
        Principal principal) {
    ...
    @AuthorizationRequired(UserRole.GENERAL)
    public ResponseEntity<ApiResponse<Void>> cancleLike(@PathVariable Long postId,
        Principal principal) {
    ...
    @AuthorizationRequired(UserRole.GENERAL)
    public ResponseEntity<ApiResponse<Void>> terminateVote(@PathVariable Long postId,
        Principal principal) {
